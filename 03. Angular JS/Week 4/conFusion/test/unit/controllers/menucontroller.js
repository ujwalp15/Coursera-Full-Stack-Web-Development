...
it('should have showDetails as false', function () {
  ...
  it('should create "dishes" with 2 dishes fetched from xhr', function(){
      ...
      expect(scope.showDishes).toBeTruthy();
      expect(scope.dishesList).toBeDefined();
      expect(scope.dishesList.length).toBe(2);

  });

  it('should have the correct data order in the dishes', function() {

      expect(scope.dishesList[0].name).toBe("Uthapizza");
      expect(scope.dishesList[1].label).toBe("New");
